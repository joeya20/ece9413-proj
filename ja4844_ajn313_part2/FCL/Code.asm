...
ADD SR1 SR1 SR7     # SR1 = SR1 + 64 - increment a pointer
ADD SR2 SR2 SR7     # SR2 = SR2 + 64 - increment W pointer
...
LS SR7 SR0 256      # SR7 = SDMEM[256] = 66304
ADD SR7 SR7 SR3     # SR7 = 66304 + i
SV VR4 SR7          # VDMEM[66304+i] = VR4[0]

# now repeat process for i in in range(256)
LS SR7 SR0 64       # SR7 = 64
MTCL SR7            # VLR = 64
ADD SR1 SR0 SR5     # SR1 = 256 (pointer to start a)
ADD SR2 SR2 SR7     # SR2 = W[i+1]  (pointer to start of next weight vector)
ADD SR3 SR3 SR6     # i++
...
ADD SR1 SR0 SR0     # SR1 = 0
ADD SR3 SR2 SR5     # SR3 = 66048 + 256 = 66304
LV VR2 SR3          # VR2 = (a * W)[:63]
LV VR1 SR2          # VR1 = b[:63]
ADDVV VR4 VR1 VR2   # VR4  = (a * W + b)[:63]
SV VR4 SR1

ADD SR1 SR1 SR7     # SR1 = SR1 + 64 - increment output pointer
ADD SR2 SR2 SR7     # SR2 = SR2 + 64 - increment b pointer
ADD SR3 SR3 SR7     # SR3 = SR3 + 64 - increment a * W pointer
LV VR2 SR2          # VR2 = b[64:127]
LV VR1 SR3          # VR1 = (a * W)[64:127]
